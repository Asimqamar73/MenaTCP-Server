...
export const imageUploadWeb = async (req, res, next) => {
  try {
    // Process the uploaded image here
    console.log("create image upload me agya")
    const file = req.file;
    ...
    req.courseThumbnail=uploadedFile,
    req.uploadedFile=uploadedFile, // idhr kam karha hu
    next();
  } catch (error) {
